...
export default function Women() {
    ...
    const articles = articlesList.map((el,i) => {
        ...
        if (el.category === 'women' && (menuItem==='Tout' || menuItem==='') && screenWidth>900){
            return article
        } else if (el.category === 'women' && menuItem===el.type && screenWidth>900){
            return article
        } else if (el.category === 'women' && (menuItem==='Tout' || menuItem==='') && screenWidth<=900){
            return smArticle
        } else if (el.category === 'women' && menuItem===el.type && screenWidth<=900){
            return smArticle
        }
  ...
  return (
    <div>
        ...
        <div className={styles.container}>
            ...
            {screenWidth<=900?
            <div>
                <h1 className={styles.menuTitle} onClick={() => setShowMenu(!showMenu)}>Femme</h1>
                {showMenu &&
