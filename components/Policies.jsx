    ...
    <div>
        ...
        <div style={{display:'flex', justifyContent:'center', alignItems:'center', height:'100vh', width:'100vw'}}>
          <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', height:'100vh', width:'30vw'}}>
            <a href="#privacy_policy" style={{textDecoration:'none', color:'black'}}><p>Politique de confidentialité</p></a>
            ...
            <a href="#legal_notice" style={{textDecoration:'none', color:'black'}}><p>Mentions légales</p></a>
          </div>
          <div style={{display:'flex', flexDirection:'column', height:'100vh', width:'65vw', overflowY:'scroll',}}>
            <div>
              <h1 id='privacy_policy'>Politique de confidentialité de Salecka</h1>

              <p>La présente Politique de confidentialité décrit la façon dont vos informations personnelles sont recueillies, utilisées et partagées lorsque vous vous rendez sur salecka.com (le « Site ») ou que vous y effectuez un achat.</p>
              ...
              Nous recueillons les Informations sur l'appareil à l'aide des technologies suivantes :</p>

              <h3 id='cookies'>FICHIERS TÉMOINS (COOKIES)</h3>

              <p>Voici une liste de fichiers témoins que nous utilisons. Nous les avons énumérés ici pour que vous ayez la possibilité de choisir si vous souhaitez les autoriser ou non.
              ...
              Lorsque nous utilisons l'expression « Informations personnelles » dans la présente Politique de confidentialité, nous faisons allusion à la fois aux Informations sur l'appareil et aux Informations sur la commande.</p>
              ...
              En outre, vous pouvez refuser certains de ces services en vous rendant sur le portail de désactivation de Digital Advertising Alliance à l'adresse suivante : https://optout.aboutads.info/?c=3&lang=fr.</p>
              ...
              <h3>MINEURS</h3>
              <p>Le Site n'est pas destiné aux individus de moins de 18 ans.</p>
              ...
              <p>Pour en savoir plus sur nos pratiques de confidentialité, si vous avez des questions ou si vous souhaitez déposer une réclamation, veuillez nous contacter par e-mail à rashaandesnoyers@hotmail.com, ou par courrier à l'adresse suivante :

              7 Allée du Perruchet, Thiais, Ile-de-France, 94320, France</p>
            </div>
            <div>
              <h1 id='terms_of_use'>Conditions générales de vente et d'utilisation</h1>

              <h3>APERÇU</h3>

              <p>Ce site web est exploité par Salecka. Partout sur le site, nous employons les termes « nous », « notre » et « nos » en référence à Salecka. Ce site web, y compris l'ensemble des informations, outils et services auquel il donne accès, est offert par Salecka à l'utilisateur que vous êtes, à condition que vous acceptiez la totalité des modalités, conditions, politiques et avis stipulés ici.
                ...
                Notre boutique est hébergée sur Shopify Inc. Cette société nous fournit la plateforme e-commerce en ligne qui nous permet de vous vendre nos produits et services.</p>
              ...
              <p>En acceptant les présentes Conditions d'utilisation, vous déclarez avoir atteint ou dépassé l'âge de la majorité dans votre région, province ou État et nous avoir donné l'autorisation de permettre à toute personne mineure à votre charge d'utiliser ce site.
                ...
                Une infraction ou une violation de n'importe laquelle des Conditions entraînera la résiliation immédiate de vos Services.</p>


              <h3>SECTION 2 – CONDITIONS GÉNÉRALES</h3>
              <p>Nous nous réservons le droit de refuser de servir quelqu'un à tout moment et pour quelque raison que ce soit.
                ...
                Les titres utilisés dans le présent accord sont inclus à titre indicatif uniquement et ne limiteront ni n'affecteront aucunement ces Conditions.</p>
              ...
              <p>Les prix de nos produits sont modifiables sans préavis.
                ...
                Nous ne pourrons être tenus responsables envers vous ou tout tiers de tout changement de prix, ou encore de toute modification, suspension ou interruption du Service.</p>

              <h3>SECTION 5 – PRODUITS OU SERVICES (le cas échéant)</h3>
              <p>Il est possible que certains produits ou services ne soient disponibles qu'en ligne à travers le site web. Il se peut que les quantités de ces produits ou services soient limitées et que leur retour ou leur échange soit strictement assujetti à notre Politique de retour.
                ...
                Nous ne garantissons pas que la qualité des produits, services, informations ou autres matériels que vous achetez ou que vous vous procurez répondra à vos attentes ni que les erreurs que comporte éventuellement le Service seront corrigées.</p>
              ...
              <p>Nous sommes susceptibles de vous fournir l'accès à des outils tiers que nous ne surveillons, ne contrôlons et ne gérons pas.
                ...
                Il se peut également qu'à l'avenir, nous proposions de nouveaux services et/ou de nouvelles fonctionnalités à travers le site web (y compris le lancement de nouveaux outils et ressources). Ces nouveaux services et/ou fonctionnalités seront aussi assujettis aux présentes Conditions d'utilisation.</p>
              ...
              <p>En plus des autres interdictions énoncées dans les Conditions d’utilisation, il vous est interdit d’utiliser le site ou son contenu :
                <br/>(a) à des fins illégales ;
                <br/>(b) pour inciter des tiers à réaliser des actes illégaux ou à y prendre part ;
                <br/>(c) pour enfreindre toute ordonnance locale ou toute réglementation, règle ou loi internationale, fédérale, provinciale ou étatique ;
                <br/>(d) pour transgresser ou violer nos droits de propriété intellectuelle ou ceux de tiers ;
                <br/>(e) pour harceler, maltraiter, insulter, blesser, diffamer, calomnier, dénigrer, intimider ou discriminer quiconque en fonction du sexe, de l’orientation sexuelle, de la religion, de l’origine ethnique, de la race, de l’âge, de l’origine nationale ou d’un handicap ;
                <br/>(f) pour soumettre des renseignements faux ou trompeurs ;
                <br/>(g) pour mettre en ligne ou transmettre des virus ou tout autre type de code malveillant qui sera ou pourrait être utilisé en vue de compromettre la fonctionnalité ou le fonctionnement du Service ou de tout site web connexe, ainsi que d'autres sites web ou d’Internet ;
                <br/>(h) pour recueillir ou suivre les renseignements personnels d’autrui ;
                <br/>(i) pour spammer, hameçonner, détourner un domaine, extorquer des informations, parcourir, explorer ou balayer le web ;
                <br/>(j) à des fins obscènes ou immorales ; ou
                <br/>(k) pour perturber ou contourner les mesures de sécurité du Service ou de tout site connexe, ainsi que d'autres sites web ou d’Internet.
                <br/>Nous nous réservons le droit de mettre fin à votre utilisation du Service ou de tout site web connexe pour avoir enfreint les interdits en matière d'utilisation.</p>
              ...
              <p>Les obligations et responsabilités engagées par les parties avant la date de résiliation resteront en vigueur après la résiliation de cet accord, et ce, à toutes fins.
                ...
                Si nous jugeons ou suspectons, à notre seule discrétion, que vous ne respectez pas ou que vous n'avez pas respecté une quelconque modalité ou disposition des présentes Conditions d’utilisation, nous pouvons également résilier cet accord à tout moment et sans préavis. Vous demeurerez alors responsable de toutes les sommes redevables jusqu’à la date de résiliation (incluse), en conséquence de quoi nous pouvons vous refuser l’accès à nos Services (ou à une partie de ceux-ci).</p>

              <h3>ARTICLE 17 – INTÉGRALITÉ DE L’ACCORD</h3>
              <p>Tout manquement de notre part à l’exercice ou à l’application d'un droit ou d'une disposition des présentes Conditions d’utilisation ne constitue pas une renonciation à ce droit ou à cette disposition.
              ...
              <p>Les présentes Conditions d’utilisation, ainsi que tout accord distinct par lequel nous vous fournissons les Services sont régis et interprétés en vertu des lois de 7 Allée du Perruchet, Thiais, Ile-de-France, 94320, France.</p>

              <h3>ARTICLE 19 – MODIFICATIONS APPORTÉES AUX CONDITIONS D’UTILISATION</h3>
              <p>Vous pouvez consulter la version la plus récente des Conditions d’utilisation à tout moment sur cette page.
              ...
              <p>Les questions relatives aux Conditions d’utilisation doivent nous être envoyées à rashaandesnoyers@hotmail.com.</p>
            </div>
            <div>
              <h1 id='reimbursement_policy'>Politique de remboursement</h1>
              <h3>RETOURS</h3>
              <p>Notre politique dure 30 jours. Si plus de 30 jours se sont écoulés depuis votre achat, nous ne pouvons malheureusement offrir ni remboursement ni échange.
                ...
                * Tout article retourné plus de 30 jours après sa livraison</p>
                
                Remboursements (le cas échéant)
                <p>Une fois votre retour reçu et inspecté, nous vous adresserons un e-mail pour vous indiquer que nous avons reçu l'article retourné. Nous vous préciserons également si votre remboursement est approuvé ou refusé.
                ...
                Si vous avez effectué toutes ces démarches et que vous n'avez toujours pas reçu votre remboursement, contactez-nous à l'adresse suivante : rashaandesnoyers@hotmail.com.
                ...
                Nous ne remplaçons que les articles initialement défectueux ou endommagés.  Si vous devez remplacer le vôtre par le même article, adressez-nous un e-mail à rashaandesnoyers@hotmail.com et envoyez votre article à : 7 Allée du Perruchet, Thiais, Ile-de-France, 94320, France.
                ...
                Expédition
                Pour retourner votre produit, vous devez l'envoyer à l'adresse postale suivante : 7 Allée du Perruchet, Thiais, Ile-de-France, 94320, France.
            ...
            <div>
              <h1 id='legal_notice'>Mentions légales</h1>

                <p>Conformément aux dispositions de la loi n° 2004-575 du 21 juin 2004 pour la confiance en l'économie numérique, il est précisé aux utilisateurs du site Salecka l'identité des différents intervenants dans le cadre de sa réalisation et de son suivi.</p>

                <h3>EDITION DU SITE</h3>
                <p>Le présent site, accessible à l’URL www.salecka.com (le « Site »), est édité par :

                Rashaan DESNOYERS, résidant 7 Allée du Perruchet 94320 THIAIS, de nationalité Française (France), né(e) le 17/12/1996, </p>

                <h3>HEBERGEMENT</h3>
                <p>Le Site est hébergé par la société Shopify Inc., situé Google LLC 1600 Amphitheatre Parkway Mountain View, CA 94043 USA, (contact téléphonique ou email : (+1) 650 253 0000).</p>

                <h3>Directeur de publication</h3>
                <p>Le Directeur de la publication du Site est Rashaan DESNOYERS.</p>

                <h3>Nous contacter</h3>
                <p>Par téléphone : +33760276334</p>
                <p>Par email : rashaandesnoyers@hotmail.com</p>
                <p>Par courrier : 7 Allée du Perruchet 94320 THIAIS</p>
